...
title({'Terminal velocity vs payload mass vs sph. parachute cross section surface', 'Cd=0.45; Ro=1.168kg/m^3; fabric gramature=26g/m^2   '});
xlabel('payload mass [kg]'); ylabel('velocity [m/s]');
